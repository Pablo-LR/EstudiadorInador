...
public class TestScreen extends javax.swing.JPanel {
     ...
     * @param parentFrame
     */
    public TestScreen(StartScreen parentFrame) {
        this.parentFrame = parentFrame;
        qBox = new QuestionBox("./contentFiles/TestSubjects.csv");
        initComponents();
        makeQuestion();
    }
    ...
    private void makeQuestion(){
        ...
        pnOpt2.removeAll();
        pnOpt3.removeAll();
        pnOpt0.add(ImageHandler.getPaneImage("./contentFiles/MatrixTest/"+showingQ.getOpcion(0).getImage()));
        pnOpt1.add(ImageHandler.getPaneImage("./contentFiles/MatrixTest/"+showingQ.getOpcion(1).getImage()));
        pnOpt2.add(ImageHandler.getPaneImage("./contentFiles/MatrixTest/"+showingQ.getOpcion(2).getImage()));
        pnOpt3.add(ImageHandler.getPaneImage("./contentFiles/MatrixTest/"+showingQ.getOpcion(3).getImage()));
    ...
    private void initComponents() {
        ...
        lblTitleSig.setText("Módulo de Matrices");
        ...
        rdbtnOp0.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdbtnOp0ActionPerformed(evt);
            }
        });
    ...
    private void rdbtnOp0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdbtnOp0ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdbtnOp0ActionPerformed
