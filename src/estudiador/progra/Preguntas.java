...
public class Preguntas extends javax.swing.JPanel {
     ...
     */
    public Preguntas(StartScreen parentFrame) {
        this.parentFrame = parentFrame;
        qBox = new QuestionBox("./contentFiles/Programacion/Preguntas.csv");
        initComponents();
        makeQuestion();
    }
    ...
    private void makeQuestion(){
        ...
        pnOpt2.removeAll();
        pnOpt3.removeAll();
        pnOpt0.add(ImageHandler.getPaneImage("./contentFiles/Programacion/Imagenes/"+showingQ.getOpcion(0).getImage()));
        pnOpt1.add(ImageHandler.getPaneImage("./contentFiles/Programacion/Imagenes/"+showingQ.getOpcion(1).getImage()));
        pnOpt2.add(ImageHandler.getPaneImage("./contentFiles/Programacion/Imagenes/"+showingQ.getOpcion(2).getImage()));
        pnOpt3.add(ImageHandler.getPaneImage("./contentFiles/Programacion/Imagenes/"+showingQ.getOpcion(3).getImage()));
    ...
    private void initComponents() {
        ...
        lblPreguntaText.setText("Texto Preguntas");
        ...
        pnOpt1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 0, true));
        ...
        pnOpt2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 0));
        ...
        pnOpt0.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 0));
        ...
        pnOpt3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 0));
